...
const mcp = new Server(
  { name: "antiphon", version: "0.1.0" },
  {
    ...
    instructions:
      ...
      "which peer spoke: always pass it back as `to`. A bare reply is refused " +
      "as soon as any named Codex peer is live, because unnamed sessions leave " +
      "no registry record and cannot be ruled out. A null sender_alias means " +
      "that peer has no name and cannot be replied to by name.",
  },
);
